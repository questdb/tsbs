...
// QWP support in go-questdb-client is post-v4.1.0 and unreleased.
// Drop this replace directive once a tag including QWP is published.
replace github.com/questdb/go-questdb-client/v4 => ../go-questdb-client
